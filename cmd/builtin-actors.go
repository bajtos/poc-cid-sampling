...
func main() {
	fmt.Printf("SystemActorAddr           : %v\n", SystemActorAddr)
	fmt.Printf("InitActorAddr             : %v\n", InitActorAddr)
	fmt.Printf("RewardActorAddr           : %v\n", RewardActorAddr)
	fmt.Printf("CronActorAddr             : %v\n", CronActorAddr)
	fmt.Printf("StoragePowerActorAddr     : %v\n", StoragePowerActorAddr)
	fmt.Printf("StorageMarketActorAddr    : %v\n", StorageMarketActorAddr)
	fmt.Printf("VerifiedRegistryActorAddr : %v\n", VerifiedRegistryActorAddr)
}
